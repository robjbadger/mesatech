<div class="section-frame">
        <div class="container">
            ...
            <form class="form-horizontal" method="POST" 
                action="mylibrary/library/UserRegistration_submit.php"
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" 
                        ...
                        data-msg-required="You must enter a user id."  style="" required></div>
    </div>
            <div class="form-group ">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" 
                        ...
                        placeholder="" 
                        data-rule-required="true"
                        data-msg-required="This field is required."  style="" required></div>
    </div>
            <div class="form-group ">
...
<div class="form-group ">
    ...
    <link rel="stylesheet" type="text/css" href="./css/UserRegistration.css"> <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
