$(document).ready(
    function(){
        ...
        var i = parseInt($('#modal_count').val());
        ...
        $( '#email_tab' ).click(function() {
            var name_tags = '';
            var response_to_saved_value = $('input#response_to_saved_value').val();
            ...
            $('.droppable_form').find('.modal').each(function() {
                ...
                if ($(this).find('.field_name').length > '0' ){
                    ...
                    if(input_type === 'text'){                        
                        if(response_to_saved_value == name) {
                            response_to_html += '<option selected value="' + name + '">' + this_label + '</option>';
                        } else {
        ...
        function dropped_event(){
            $( '.btn-edit' ).click(function() {
                ...
                $('.other_validation').each(function() {
