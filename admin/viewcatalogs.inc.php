<div class="section-frame">
	...
	$sql = "SELECT created, modified, end_date, custid FROM catalogs WHERE catalogid = $catalogid";
	...
	echo "<tr><th>Modified:</th><td>$modified</td></tr>";
	echo "<tr><th>End Date:</th><td>$end_date</td></tr>";
	echo "<tr><th>Customer:</th><td>$custid</td></tr>";
